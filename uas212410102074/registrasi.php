          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <!-- CONTACT FORM HERE -->
                         <form action="" method="POST" id="appointment-form" role="form" enctype="multipart/form-data">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" autofocus autocomplete="off" required>
                                   </div>
                                   ...
                                   <div class="col-md-12 col-sm-12">
                                        ...
                                        <br>
                                        <button type="submit" class="form-control" id="cf-submit" name="registrasi">DAFTAR</button>
                                   </div>
                              </div>
                         </form>
                    </div>
